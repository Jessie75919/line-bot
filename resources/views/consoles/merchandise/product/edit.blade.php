        ...
        <div class="panel">
            <div class="panelBody bt-wrapper">
                ...
                <div class="editListBtn start">
                    ...
                    <a href="#"
                       id="updateContentBtn"><i class="fas fa-edit"></i>確認編輯</a>
                </div>
                <!--編輯按鈕區塊 end-->
                <!--新增商品資訊-->
                <form action="#"
                    ...
                    <div class="formList">
                        ...
                        <div class="formInfo">
                            <input type="text"
                                   name="quantity"
                                   id="quantity"
                                   value="{{ $product->productCount->count }}">
                        </div>
                    </div>
                        ...
                        <div class="formInfo">
                            <div class="dbImg"
                                ...
                                @foreach($product->getImages('product') as $image)
                                    <figure id="pro_{{ $image->id }}"
                                            data-order="{{ $image->order }}">
                                        <img src="{{ $image->image_url }}">
                                        <a id="pro_del_{{ $image->id }}"
...
//                myDropzone.removeFile(file);
        ...
        function sendData(){
            ...
            let sendTextTypeData = () =>{
                return axios({
                    method : 'put',
                    url    : '/merchandise/product/' + productId,
                    data   : data
                })
            };
            ...
            handle()
                .then(() =>{
                    swal("商品更新成功！", {
                        ...
                        location.replace('{{route('merchandise.product.index')}}');
                    });
