...
(function () {
  ...
  (function () {
    ...
    CKEDITOR.tools = {
      ...
      transformPlainTextToHtml: function (a, e) {
        ...
        if (!b) {
          var g = /\n{2}/g;
          if (g.test(v)) var d = '\x3c' + c + '\x3e', m = '\x3c/' + c + '\x3e', v = d + v.replace(g, function () {
            return m + d;
          }) + m;
        }
        v = v.replace(/\n/g, '\x3cbr\x3e');
  ...
  (function () {
    ...
    var h = {
      ...
      n = CKEDITOR.dom.walker.editable(), r = CKEDITOR.dom.walker.ignored(!0);
  ...
  (function () {
    ...
    var q = CKEDITOR.dtd, E = CKEDITOR.tools.copy, z = CKEDITOR.tools.trim,
      H = ['', 'p', 'br', 'div'];
  ...
  (function () {
    function a(a, d) {
      ...
      function q(a, b) {
        ...
        var c;
        return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(m)) && (c.foody && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.foody))).insertBefore(a),
  ...
  (function () {
    ...
    function C() {
      ...
      return {
        get: function (c) {
          return 'plain-text' == c ? b.plainText || (b.plainText = new CKEDITOR.filter('br')) : 'semantic-product' == c ? ((c = b.semanticContent) || (c = new CKEDITOR.filter, c.allow({
            $1: {
              elements: a(),
              attributes: !0,
              styles: !1,
    ...
    CKEDITOR.plugins.add('clipboard', {
      requires: 'dialog,notification,toolbar', init: function (a) {
        var b, c = C();
        a.config.forcePasteAsPlainText ? b = 'plain-text' : a.config.pasteFilter ? b = a.config.pasteFilter : !CKEDITOR.env.webkit || 'pasteFilter' in a.config || (b = 'semantic-product');
        ...
        renderHtml: function (a) {
          ...
          if (!this._.panel) {
            var b = this._.panelDefinition, c = this._.panelDefinition.block,
              ...
              b = e.addListBlock(this.id, c), d = this;
            e.onShow = function () {
      ...
      $: function () {
        ...
        setData: function (a, f) {
          ...
          if (f) this.setHtml(a), this.fixInitialSelection(), b.fire('dataReady'); else {
            ...
            (a = a.replace(/<body[^>]*>/, '$\x26\x3c!-- cke-product-start --\x3e')));
  ...
  (function () {
    ...
    var v = { ol: 1, ul: 1 }, K = CKEDITOR.dom.walker.whitespaces(),
      H = CKEDITOR.dom.walker.bookmark(), u = function (b) {
        return !(K(b) || H(b));
  ...
  (function () {
      ...
      v(d, {
        attach: function () {
          ...
          v(G('\x3cspan title\x3d"' + a.editor.lang.magicline.title + '" contenteditable\x3d"false"\x3e\x26#8629;\x3c/span\x3e', c), {
            ...
            base: X + 'right:0px;border-right-color:' + a.boxColor + ';', looks: [
    ...
    var v = CKEDITOR.tools.extend, R = CKEDITOR.dom.element, G = R.createFromHtml, t = CKEDITOR.env,
      ja = CKEDITOR.env.ie && 9 > CKEDITOR.env.version, B = CKEDITOR.dtd, K = {}, I = 128, da = 64,
      T = 32, M = 16, C = 4, D = 2, x = 1, J = ' ', fa = B.$listItem, oa = B.$tableContent,
    ...
    var ha = function () {
      ...
      F = CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_COMMENT), ia = function () {
        function a(a) {
    ...
    function v(a) {
      ...
      if (a.data.getTarget().getName && ('mouseup' === a.name || !B(a.data.getTarget()))) {
        var e = a.editor || a.listenerData.editor,
          h = e.getSelection(1), m = I(e), l = a.data.getTarget(),
          k = l && l.getAscendant({ td: 1, th: 1 }, !0), l = l && l.getAscendant('table', !0),
    ...
    function ba(a) {
      ...
      if (CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT) {
        var c = this.repository.finder,
          d = this.repository.locator, e = this.repository.liner, f = this.editor,
          h = f.editable(), g = [], k = [], m, n;
